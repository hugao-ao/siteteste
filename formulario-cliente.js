...
function renderImpostoRendaQuestions() {
    ...
    if (preenchedor) {
        ...
        entryDiv.innerHTML = `
            ...
            <div class="radio-options-inline" style="display: flex; align-items: center; flex-wrap: wrap; gap: 1rem;">
            ...
            <div class="imposto-renda-additional-questions" style="display: none; margin-top: 1rem; margin-left: 0; padding-left: 0; border-left: none;">
                <div style="margin-bottom: 1.5rem;">
                    <label for="${personId}_tipo" style="display: block; margin-bottom: 0.5rem;">Qual o tipo?</label>
                    <div class="radio-options-inline" style="display: flex; align-items: center; flex-wrap: wrap; gap: 1rem;">
                        <span style="display: flex; align-items: center;">
                            <input type="radio" id="${personId}_tipo_simples" name="${personId}_tipo" value="simples">
                            <label for="${personId}_tipo_simples">Simples</label>
                        </span>
                        <span style="display: flex; align-items: center;">
                            <input type="radio" id="${personId}_tipo_completa" name="${personId}_tipo" value="completa">
                            <label for="${personId}_tipo_completa">Dedução Completa</label>
                        </span>
                        <span style="display: flex; align-items: center;">
                            <input type="radio" id="${personId}_tipo_naosei" name="${personId}_tipo" value="nao_sei">
                ...
                <div>
                    ...
                    <div class="radio-options-inline" style="display: flex; align-items: center; flex-wrap: wrap; gap: 1rem;">
                        <span style="display: flex; align-items: center;">
                            <input type="radio" id="${personId}_resultado_paga" name="${personId}_resultado" value="paga">
                            <label for="${personId}_resultado_paga">Paga</label>
                        </span>
                        <span style="display: flex; align-items: center;">
                            <input type="radio" id="${personId}_resultado_recebe" name="${personId}_resultado" value="recebe">
                            <label for="${personId}_resultado_recebe">Recebe</label>
                        </span>
                        <span style="display: flex; align-items: center;">
                            <input type="radio" id="${personId}_resultado_isento" name="${personId}_resultado" value="isento">
                            <label for="${personId}_resultado_isento">Isento</label>
                        </span>
                        <span style="display: flex; align-items: center;">
                            <input type="radio" id="${personId}_resultado_naosei" name="${personId}_resultado" value="nao_sei">
    ...
    if (clientResponseFormEl) {
        clientResponseFormEl.addEventListener("submit", async (e) => {
            ...
            try {
                ...
                window.location.href = 'https://hvsaudefinanceira.com.br/bem-vindo';
