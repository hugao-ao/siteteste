// Função para injetar o HTML da Sidebar do Admin (MODIFICADA com Gerenciamento Sempre Visível + HVC)
...
// Função para Criar Sidebar para Admin Visualizando como Usuário (MODIFICADA para incluir HVC)
