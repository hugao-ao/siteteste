...
function createAdminSidebarHTML(projectContext = null) {
    ...
    if (projectContext === 'Hvc') {
        ...
        projectSpecificLinks = `
            <li class="sub-menu"><a href="planejamento-dashboard.html" id="nav-planejamento-dashboard"><i class="fas fa-chart-pie"></i> <span>Dashboard Planejamento</span></a></li>
...
function createAdminViewingUserSidebarHTML(viewedUserProject) {
    ...
    if (viewedUserProject === 'Hvc') {
        ...
        projectSpecificLinks = `
            <li><a href="planejamento-dashboard.html" id="nav-planejamento-dashboard"><i class="fas fa-chart-pie"></i> <span>Dashboard Planejamento</span></a></li>
            <li><a href="clientes-dashboard.html" id="nav-gerenciar-clientes"><i class="fas fa-briefcase"></i> <span>Gerenciar Clientes</span></a></li>
            <li><a href="mensagens-whats.html" id="nav-mensagens-whats"><i class="fab fa-whatsapp"></i> <span>Mensagens Whats</span></a></li>
        `;
    } else {
...
async function injectSidebar(mainContentElementId) { // Tornou-se async
    ...
    // *** DETECTAR PROJETO ATIVO: da URL ou da página atual ***
    const urlParams = new URLSearchParams(window.location.search);
    let projectFromUrl = urlParams.get('projeto');
