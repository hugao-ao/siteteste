 ...
 * =========================================================
 * CÓPIA v2 (pasta diagnostico/): idêntica à da raiz, exceto o caminho
 * da tela de login, que aqui é '../index.html' porque esta pasta fica
 * um nível abaixo. A versão da raiz NÃO deve ser alterada.
 *
...
(function () {
    ...
    if (!temPermissao) {
        ...
        // Redireciona para a página de login (um nível acima desta pasta)
