    ...
    fluxo: function(diag) {
      ...
      const itemsDespesa = despesas.filter(d => !d.automatica).map(d => {
        ...
        return {
          ...
          // v2: a classificação feita no diagnóstico vem junto; sem ela, valem os defaults antigos
          alteravel: d.alteravel || 'nao',
          disposto: d.disposto || 'nao',
          importancia: d.nivel_importancia || '5',
          conforto: d.nivel_conforto || '3',
