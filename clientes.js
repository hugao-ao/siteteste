...
function renderConsolidadoDiagnosticoDash(d) {
    ...
    // 9 degraus do formato novo (as 7 chaves da escala atual têm o mesmo nome) + escala de 7 "com GARANTIA" + extras da escala de 10
    const RISCO_LABELS = {'RISCO_SOBERANO':'Risco Soberano','RISCO_MUITO_BAIXO':'Risco Muito Baixo','RISCO_BAIXO':'Risco Baixo','RISCO_MEDIO_BAIXO':'Risco Médio-Baixo','RISCO_MEDIO':'Risco Médio','RISCO_MEDIO_ALTO':'Risco Médio-Alto','RISCO_ALTO':'Risco Alto','RISCO_MUITO_ALTO':'Risco Muito Alto','RISCO_MAXIMO':'Risco Máximo','RISCO_BAIXO_SEM_GARANTIA':'Risco Baixo (Sem Garantia)','RISCO_ALTO_PROTECAO_MRP':'Risco Alto (Proteção MRP)','RISCO_MUITO_ALTO_PROTECAO_MRP':'Risco Muito Alto (Proteção MRP)','RISCO_MUITO_BAIXO_GARANTIA_SOBERANA':'Risco Muito Baixo (Garantia Soberana)','RISCO_MUITO_BAIXO_GARANTIA_FGC':'Risco Muito Baixo (Garantia FGC)','RISCO_BAIXO_GARANTIA_FGC':'Risco Baixo (Garantia FGC)','RISCO_MEDIO_SEM_GARANTIA':'Risco Médio','RISCO_ALTO_SEM_GARANTIA':'Risco Alto','RISCO_MUITO_ALTO_SEM_GARANTIA':'Risco Muito Alto','RISCO_ABSOLUTO_SEM_GARANTIA':'Risco Absoluto'};
